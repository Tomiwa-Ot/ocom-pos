        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    mIPosPrinterService.printBlankLines(1, 16, callback);
                    mIPosPrinterService.printSpecifiedTypeText("      开启打印测试\n", "ST", 32, callback);
                    ...
                    mIPosPrinterService.printSpecifiedTypeText("      打印测试完成\n", "ST", 32, callback);
       ...
       ThreadPoolManager.getInstance().executeTask(new Runnable() {
           ...
           public void run() {
               ...
               try{
                   ...
                   mIPosPrinterService.printBitmap(1, 4, mBitmap, callback);
                   mIPosPrinterService.printBlankLines(1, 10, callback);

                   mIPosPrinterService.printBitmap(2, 4, mBitmap, callback);
                   mIPosPrinterService.printBlankLines(1, 10, callback);

                   mIPosPrinterService.printBitmap(2, 6, mBitmap, callback);
                   mIPosPrinterService.printBlankLines(1, 10, callback);

                   mIPosPrinterService.printBitmap(1, 6, mBitmap, callback);
                   mIPosPrinterService.printBlankLines(1, 10, callback);

                   mIPosPrinterService.printBitmap(0, 6, mBitmap, callback);
                   mIPosPrinterService.printBlankLines(1, 10, callback);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                ...
                try{
                    ...
                    mIPosPrinterService.printBitmap(1, 3, bmp, callback);
                    mIPosPrinterService.printBitmap(2, 8, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 10, callback);
        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                ...
                try{
                    ...
                    mIPosPrinterService.printBitmap(1, 4, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(1, 5, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(1, 6, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(1, 7, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(1, 8, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);

                    mIPosPrinterService.printBitmap(2, 4, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(3, 5, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(4, 6, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
                    mIPosPrinterService.printBitmap(5, 7, bmp, callback);
                    mIPosPrinterService.printBlankLines(1, 20, callback);
